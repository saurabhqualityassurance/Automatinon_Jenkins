...
public class MarketingLeadsTestScripts extends BaseTest{
	...
	public void verifyVT007SearchLeads() {
		...
		if (searchedName.contains(expFirstName)) {
			webUtil.printMessage("passed! your data "+searchedName+" is matched that you are searching");
		} else {
			webUtil.printMessage("failed! your data "+searchedName+" is not  matched that you are searching");
		}
		webUtil.printMessage("====  verifyVT008SearchLeads starts from here====");
	}
