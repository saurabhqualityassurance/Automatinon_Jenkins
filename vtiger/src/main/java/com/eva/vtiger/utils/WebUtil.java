...
public  void myThread(long duration)  {
	...
	public  void windowMaximize() {
		...
		try {
			...
			extTest.log(Status.INFO, "Browser is maximized");
...
//  using ---- title or url se window 
	...
	public  int getRowNumberByUniqueColumnRowID(String tableXpath,String tableName,String uniquColumnName,String uniqueColumnName) {
	...
	public void verifyTitle(String expTitle) {
		...
		if (actPageTitle.equalsIgnoreCase(expTitle)) {
			webUtil.printMessage("Passed. Actual-"+actPageTitle+" && Expected-"+expTitle);
		} else {
			webUtil.printMessage("Failed. Actual-"+actPageTitle+" && Expected-"+expTitle);
		}
	...
	public void verifyUrl(String expectedUrl) {
		...
		if (actualUrl.equalsIgnoreCase(expectedUrl)) {
			webUtil.printMessage("Passed. Actual-"+actualUrl+" && Expected-"+expectedUrl);
		} else {
			webUtil.printMessage("Failed. Actual-"+actualUrl+" && Expected-"+expectedUrl);
		}
	...
	public  void verifText(String actualString,String expectedString,String message) {
		if(actualString.equalsIgnoreCase(expectedString)) {
			printMessage("the actual :-"+actualString+" && expected :-"+expectedString+" both are same");
		}else {
		   
			printMessage("the actual :-"+actualString+" && expected :-"+expectedString+" both are not same");
		}
	...
	public void verifyElementVisibility(WebElement we) {
		...
		if(actStatus==true) {
			printMessage("Passed !,The Element is Displayed");
		}else {
			printMessage("Failed !,The Element is Displayed");
		}
	...
	public void verifySelectedDropOrRadioBT(WebElement we) {
		...
		if(actStatus==true) {
			printMessage("Passed !,The Element is Selected");
		}else {
			printMessage("Failed !,The Element is Selected");
		}
		 Assert.assertTrue(actStatus,"It is also verified By Assertion");
	...
	public void verifyEnabled(WebElement we) {
		...
		if(actStatus==true) {
			printMessage("Passed !,The Element is Enabled");
		}else {
			printMessage("Failed !,The Element is Enabled");
		}
		 Assert.assertTrue(actStatus,"It is also verified By Assertion");
...
//       }
	...
	public void verifyAttributeValue(WebElement we, String attributeName ,String expectedAttribute) {
		...
		if (actualAttribute.equalsIgnoreCase(expectedAttribute)) {
			webUtil.printMessage("Passed. Actual-"+actualAttribute+" && Expected-"+expectedAttribute);
		} else {
			webUtil.printMessage("Failed. Actual-"+actualAttribute+" && Expected-"+expectedAttribute);
		}
	}
